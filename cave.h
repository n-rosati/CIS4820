...
#ifndef CIS4820_CAVE_H
#define CIS4820_CAVE_H

#include "utilities.h"

//Perlin noise functions
//Permutation table found in the given Wikipedia article for Perlin Noise
static int PERMUTATION2[] = {151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36,
...
/**Generates a new cave level*/
Level* generateCaveLevel();
/**Gets the parabolic ceiling height. Intended to be used with perlin noise function.*/
float getCeilingHeight(TwoTupleFloat coordinate);
/**Places the cave's stairs*/
void placeCaveStairs(Level* level);

#endif //CIS4820_CAVE_H
